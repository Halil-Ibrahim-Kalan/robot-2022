...
import frc.robot.commands.Auto.AutoTurret.LeftScanTurret;
...
import frc.robot.subsystems.deneme;
...
public class RobotContainer {
  ...
  public final deneme m_deneme = new deneme();

  /** The container for the robot. Contains subsystems, OI devices, and commands. */
  public RobotContainer() {
    // Configure the button bindings
    configureButtonBindings();
    m_robotDrive.setDefaultCommand(new DriveCommand(m_robotDrive,() -> -m_driverController.getRawAxis(1),() -> m_driverController.getRawAxis(4), false));
  }
  ...
  private void configureButtonBindings() {
    ...
    // Turret Auto
    new JoystickButton(m_operatorController, 1).whileHeld(new OnlyMiddleTurret(m_turret, m_vision));
    new JoystickButton(m_operatorController, 10).whileHeld(new LeftScanTurret(m_turret, m_vision));
