...
import frc.robot.commands.Intake.IntakeTriggerCommandGroup;
...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    // Intake and Tunnel
    new JoystickButton(f310, 5).whileHeld(new IntakeTriggerCommandGroup(intake, trigger, 1));
    ...
    // Climb Left
    new JoystickButton(panel2, 7).whileHeld(new LeftClimbCommand(climb, 1));
    new JoystickButton(panel2, 8).whileHeld(new LeftClimbCommand(climb, -1));
    new JoystickButton(panel, 12).whileHeld(new LeftWindowCommand(climb, 1));
    new JoystickButton(panel, 11).whileHeld(new LeftWindowCommand(climb, -1));
    
    // Climb Right
    new JoystickButton(panel2, 9).whileHeld(new RightClimbCommand(climb, 1));
    new JoystickButton(panel2, 4).whileHeld(new RightClimbCommand(climb, -1));
    new JoystickButton(panel, 7).whileHeld(new RightWindowCommand(climb, -1));
    new JoystickButton(panel, 5).whileHeld(new RightWindowCommand(climb, 1));
  ...
  public Command getAutonomousCommand() {
    ...
    return new Autonomous(drive, tunnel, shooter, turret, vision, climb, intake, led, trigger);
  }
}
