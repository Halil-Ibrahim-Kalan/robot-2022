...
public class AutoBall extends SequentialCommandGroup {
  ...
  public AutoBall(TurretSubsystem turret, VisionSubsystem vision, ShooterSubsystem shooter, TriggerSubsystem trigger, FunnelSubsystem funnel) {
    ...
    addCommands(
      ...
      new ParallelCommandGroup(
        ...
        new RunCommand(() -> funnel.runFunnel(0.4), funnel),
        new RunCommand(() -> shooter.runShooter(0.4), shooter)
      ){
        @Override
